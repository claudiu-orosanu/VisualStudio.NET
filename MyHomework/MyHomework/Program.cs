...
namespace MyHomework
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            e1.DisplayInfo();
            var l1 = new Leave(new DateTime(2016,07,15), 12, LeaveTypeEnum.Holiday);
            var l2 = new Leave(new DateTime(2016, 08, 05), 17, LeaveTypeEnum.Holiday);
            var l3 = new Leave(new DateTime(2016,09,20), 7, LeaveTypeEnum.Medical);
            e1.AddNewLeave(l1);
            e1.AddNewLeave(l2);
